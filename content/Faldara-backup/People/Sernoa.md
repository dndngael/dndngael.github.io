---
{"publish":true,"aliases":"God of Decay God of Disease","created":"2025-11-25T23:26:37.716-06:00","modified":"2026-03-04T22:21:46.215-06:00","tags":["#Character","#NPC","#Deity"],"cssclasses":""}
---
...
> |||
> |---|---|
> |**Aliases** | God of Decay,God of Disease |
> |**Pronouns** | He/Him |
> |**Alignment** | Neutral Evil |


# **Sernoa** <span style="font-size: medium">"sehr-NOH-uh"</span>
...
Sernoa is the god of inevitable decay and the force of entropy that breaks down all things. His followers often believe that through understanding disease and death, they can harness its power to transform or destroy.
...
## Notes
Followers: Called "Sernoans", the followers of Sernoa tend to be necromancers, gravekeepers, (maybe questionable) doctors, and those who believe in the inevitability of decay. They are not thought highly of and tend to be secretive.
### Divine Domains
Death, Nature, Poison, Undeath

### Divine Symbols and Sigils
- A skull with decaying vines growing through it
- Animals: Rats, vultures
- Colors: Green, black, yellow

### Holidays
The Day of Rot: a dark festival where offerings are left to rot and followers ask Sernoa for immunity from disease.

The Purge of Decay: a cleansing ritual to ward off death, though it often leaves a trail of suffering behind.
